...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] /* _BASE */ = LAYOUT_split_3x6_3(
        ...
        KC_LGUI, LT(_SYMBOLS,KC_BSPC), LSFT_T(KC_ESC), /****/ RSFT_T(KC_ENT), LT(_FUNCS,KC_SPC), KC_RGUI
    ),
    ...
    [2] /* _SYMBOLS */ = LAYOUT_split_3x6_3(
        XXXXXXX,  KC_TAB,    XXXXXXX,  KC_LCBR,  KC_RCBR,  KC_ASTR,     /****/ KC_KP_PLUS,   KC_1,  KC_2,  KC_3,  KC_KP_ASTERISK,  XXXXXXX,
        XXXXXXX,  KC_QUOT,   KC_BSLS,  KC_LPRN,  KC_RPRN,  KC_UNDS,     /****/ KC_KP_MINUS,  KC_4,  KC_5,  KC_6,  KC_KP_SLASH,     XXXXXXX,
        XXXXXXX,  KC_TILDE,  KC_GRV,   KC_LBRC,  KC_RBRC,  KC_KP_MINUS, /****/ KC_KP_DOT,    KC_7,  KC_8,  KC_9,  KC_KP_EQUAL,     XXXXXXX,
    ...
    [3] /* _FUNCS */ = LAYOUT_split_3x6_3(
        ...
        XXXXXXX,  TO(_GAMING),  TO(_BASE),  XXXXXXX,  XXXXXXX,  XXXXXXX, /****/ XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,   KC_F12,  XXXXXXX,
...
#ifdef ENCODER_MAP_ENABLE
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [0...2] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_MPRV, KC_MNXT), ENCODER_CCW_CW(RM_VALD, RM_VALU), ENCODER_CCW_CW(KC_RGHT, KC_LEFT) },  // BASE/GAMING/SYMBOLS
    [3]    = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_MPRV, KC_MNXT), ENCODER_CCW_CW(KC_NO, KC_NO),     ENCODER_CCW_CW(KC_RGHT, KC_LEFT) },  // FUNCS - disable RGB encoder
    [4]    = { ENCODER_CCW_CW(KC_NO,   KC_NO),   ENCODER_CCW_CW(KC_NO, KC_NO),   ENCODER_CCW_CW(KC_NO, KC_NO),     ENCODER_CCW_CW(KC_NO, KC_NO) },      // RGB  - all encoders off
};
#endif

// const uint16_t PROGMEM base_combo[] = { KC_P, KC_BSPC, COMBO_END };
combo_t key_combos[] = {
//     COMBO(base_combo, TG(_BASE)),
};
...
bool oled_task_user(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        ...
        case _SYMBOLS: oled_write_P(PSTR("symbols"), false); break;
        case _FUNCS:   oled_write_P(PSTR("funcs"), false); break;
