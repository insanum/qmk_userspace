...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] /* _BASE */ = LAYOUT_split_3x6_3(
        ...
        XXXXXXX,  KC_Z,          KC_X,          KC_C,          KC_V,          KC_B, /****/ KC_N,  KC_M,          KC_COMM,       KC_DOT,        KC_SLSH,          XXXXXXX,
                                            ...
                                            KC_LGUI, LT(_SYMBOLS,KC_BSPC), KC_LSFT, /****/ RSFT_T(KC_ENT), LT(_FUNCS,KC_SPC), HYPR_T(KC_ESC)
    ),
    ...
    [1] /* _GAMING */ = LAYOUT_split_3x6_3(
        ...
        KC_LSFT,  KC_Z,  KC_X,  KC_C,  KC_V,  KC_B, /****/ KC_N,  KC_M,  KC_COMM,  KC_DOT,  KC_SLSH,  KC_BSLS,
            ...
            LGUI_T(KC_SPC), LALT_T(KC_SPC), LSFT_T(KC_ESC), /****/ RSFT_T(KC_ENT), LT(_FUNCS,KC_SPC), MO(_SYMBOLS)
    ),
